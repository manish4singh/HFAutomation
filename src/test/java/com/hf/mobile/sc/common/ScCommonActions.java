package com.hf.mobile.sc.common;
...
public class ScCommonActions extends TrigonUtils {
    private static final Logger logger = LogManager.getLogger(ScCommonActions.class);
